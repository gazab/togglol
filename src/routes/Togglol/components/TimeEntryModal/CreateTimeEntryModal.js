                        ...
                        <form>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-10">
                                    <p className="form-control-static">
                                        <input type="text" value={this.state.description} className="form-control" autofocus onChange={(event) => this.changeDescription(event.target.value)} onKeyPress={(e) => this.onKeyPress(e)} ref={input => input && input.focus()}/>    
                                    </p>
                                </div>
                            </div>
                            <div className="form-group row">
